...
export const LegalCaseStrategySimulator = () => {
  ...
  const downloadCaseAnalysis = () => {
    ...
    doc.setFontSize(12)
    doc.setFont('helvetica', 'normal')
    doc.text('Generated by Tim Harmar Legal - Case Strategy Simulator', 105, 35, { align: 'center' })
    ...
    doc.setFont('helvetica', 'normal')
    const disclaimerText = 'This analysis provides general information only and does not constitute legal advice. For personalized legal guidance, schedule a consultation with Tim Harmar Legal.'
